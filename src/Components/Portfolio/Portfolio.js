...
const Portfolio = () => {
    ...
    return (
        <div className='mt-24 text-center'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 m-12' data-aos="zoom-in-up" data-aos-duration="1000">
                {
                        ...
                        <div key={project._id} className='shadow-lg'>
                            ...
                            <div className="card-body">
                                ...
                                <div className="card-actions justify-end">
                                    <Link
                                        className='btn bg-[#40ABB0] text-white hover:bg-teal-700' to={`/details/${project._id}`}
                                    >View Details
                                    </Link>
                                </div>
                            </div>
